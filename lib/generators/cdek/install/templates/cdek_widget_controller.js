...
// Stimulus-контроллер виджета ПВЗ СДЭК. Установлен генератором гема:
//   bin/rails generate cdek:install
//
// Подгружает UMD-бандл виджета по адресу cdek_widget_script_url_value
// (по умолчанию — /assets/cdek/widget.umd.js, отдаётся самим гемом через
// asset pipeline) и инициализирует window.CDEKWidget в указанном root-таргете.
// При выборе пункта пишет данные в скрытые поля по их DOM-id и диспатчит
// событие `cdek-widget:chosen` для всех желающих.
